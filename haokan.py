...
def search_video_url(search_content):
    ...
    box = tree.xpath('//a[@target="_blank"]/@href')
    return (box)
...
def download_video(video_url):
    ...
    if response.status_code == 200:
        ...
        save_path = os.path.join('下载的视频(haokan)', video_filename)  # 创建一个下载目录
...
def main():
    ...
    if mode==1:
        ...
        driver.get(f'https://haokan.baidu.com/web/search/page?query={search_word}')
